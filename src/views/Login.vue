  ...
  <div class="min-h-screen bg-okx-dark flex items-center justify-center p-4">
    <div class="w-full max-w-md">
      ...
      <div class="text-center mb-8">
        <div
          class="w-20 h-20 bg-okx-blue rounded-full flex items-center justify-center mx-auto mb-4"
        >
          <svg
      ...
      <!-- 登录表单 -->
      <div class="card p-8">
        <h2 class="text-2xl font-bold text-okx-text mb-6 text-center">
          登录账户
        </h2>

        <form @submit.prevent="handleLogin" class="space-y-6">
          <div>
            <label class="block text-okx-text-secondary text-sm mb-2"
              >用户名</label
            >
            <input
