  ...
  <div class="min-h-screen bg-okx-dark pb-20">
    ...
    <header class="bg-okx-gray border-b border-okx-light-gray px-4 py-4">
      <div class="flex items-center space-x-4">
        ...
        <div class="flex-1">
          ...
          <p class="text-okx-text-secondary text-sm">
    ...
    <div v-if="wallet" class="p-4">
      ...
      <div class="grid grid-cols-2 gap-4 mb-6">
        ...
        <div class="card p-4">
          <div class="text-okx-text-secondary text-sm">交易次数</div>
          <div class="text-lg font-semibold text-okx-green">
            {{ stats.transactionCount?.toFixed(0) || "0" }}
          </div>
        </div>
        <div class="card p-4">
          ...
          <div
            ...
            :class="stats.totalReturn >= 0 ? 'text-okx-green' : 'text-okx-red'"
          >
        ...
        <div class="card p-4">
          ...
          <div
            class="text-lg font-semibold"
            :class="
              stats.totalReturnPercent >= 0 ? 'text-okx-green' : 'text-okx-red'
            "
          >
      ...
      <!-- <div class="card p-4 mb-6">
        ...
        <div class="grid grid-cols-3 gap-4">
          <div class="text-center">
            <div class="text-2xl font-bold text-okx-text">
              {{ stats.transactionCount || 0 }}
            </div>
            <div class="text-okx-text-secondary text-sm">总交易数</div>
          </div>
          <div class="text-center">
            <div class="text-2xl font-bold text-okx-green">
              {{ stats.profitTransactions || 0 }}
            </div>
            <div class="text-okx-text-secondary text-sm">盈利交易</div>
          </div>
          <div class="text-center">
            <div class="text-2xl font-bold text-okx-red">
              {{ stats.lossTransactions || 0 }}
            </div>
...
const stats = computed(() => {
  if (authStore.currentUser) {
    return transactionStore.totalTransactions.stats;
  }
  return {};
});
